...
{	
    if($username=="admin" && $password=="321" && $user_CSRF==$_SESSION['CSRF'] && $user_sessionID==session_id())
    {
    echo "<script> alert('Login Sucess') </script>";
    echo "Hellow Admin"."<br/>"; 
    ...
    echo "Login Failed..!! "."<br/>"."Authorization Failier.Please reset..!";       
    }	
}
?>